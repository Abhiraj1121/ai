...
🧠 Training Astra with School Knowledge
...
Astra will match exact questions and reply instantly. For other queries, it uses the AI backend.
...
Astra will reply with voice and text.
