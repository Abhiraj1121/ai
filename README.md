...
🧠 Training GURUBot with School Knowledge
...
GURUBot will match exact questions and reply instantly. For other queries, it uses the AI backend.
...
GURUBot will reply with voice and text.
